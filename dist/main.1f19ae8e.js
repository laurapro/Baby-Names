...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var babyNameDisplay = document.getElementById("babyNameDisplay");
  var likeButton = document.getElementById("likeButton");
  var dislikeButton = document.getElementById("dislikeButton");
  var imageContainer = document.querySelector(".image-container");
  var currentBabyName = null;

  // Function to fetch a random baby name
  function fetchRandomBabyName() {
    return _fetchRandomBabyName.apply(this, arguments);
  } // Function to update the baby name display
  function _fetchRandomBabyName() {
    _fetchRandomBabyName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("https://us-east-2.aws.data.mongodb-api.com/app/data-vnjts/endpoint/data/v1/action/findOne", {
              ...
              headers: {
                ...
                "api-key": "7ATWjGF94FLT0sLEmNzaLCWxpqr8N23gPqKfBSwuO9VrHzN8Kj1lCzU0zHULqI6g"
              }
            });
          case 3:
            ...
            throw new Error("No baby name found");
          case 6:
            return _context.abrupt("return", response.data);
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            console.error("Error fetching random baby name:", _context.t0);
          case 12:
          case "end":
  ...
  function updateBabyNameDisplay() {
    fetchRandomBabyName().then(function (babyName) {
      ...
      imageContainer.style.backgroundImage = "url(".concat(getImageUrl(babyName.gender), ")");
    });
  }
...
function updatePopularity(_x, _x2) {
  return _updatePopularity.apply(this, arguments);
}
function _updatePopularity() {
  _updatePopularity = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, increment) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.post("https://us-east-2.aws.data.mongodb-api.com/app/data-vnjts/endpoint/data/v1/action/updatePopularity/".concat(name, "/").concat(increment), null, {
            headers: {
              "Content-Type": "application/json",
              "Access-Control-Request-Headers": "*",
              "api-key": "7ATWjGF94FLT0sLEmNzaLCWxpqr8N23gPqKfBSwuO9VrHzN8Kj1lCzU0zHULqI6g"
        ...
        case 5:
          ...
          console.error("Error updating popularity:", _context2.t0);
        case 8:
        case "end":
